...
plan. The union is then deduplicated by realized plan. The resulting
fine-search size is \TBD{TBD_AFTER_FINALISE_COARSE}.
...
Amendment 002 (revised), sealed & \TBD{TBD_AFTER_FINALISE_COARSE} \\
Structural-floor audit & \TBD{TBD_AFTER_FINALISE_COARSE} \\
...
\begin{itemize}
\item Combined coarse ranking (top realized plans with aliases, active
constraints, design $\Jp$ labelled as selection-optimistic), fine-search
counts per winner and in total, validation table of the ten finalists:
