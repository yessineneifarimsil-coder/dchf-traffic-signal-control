...
OUT_RAW = "results/raw/n10_coarse_benchmark_raw.csv"
OUT_SWEEP = "results/tables/n10_coarse_offset_sweep_summary.csv"
OUT_DCHF = "results/tables/n10_coarse_benchmark_dchf_summary.csv"
...
def scenario_paths(distance, demand_name):
    ...
    return {
        scenario_dir = f"sumo_scenarios/scalability/corridor_10x2_d{distance}m_{demand_name}"
