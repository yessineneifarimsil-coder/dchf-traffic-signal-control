...
INPUT_CSV = "results/tables/multiseed_offset_qmix_per_second_summary.csv"
OUTPUT_FIG = "results/figures/multiseed_robustness_waiting_time.png"
...
def main():
    ...
    plt.title("Multi-Seed Robustness Comparison")
