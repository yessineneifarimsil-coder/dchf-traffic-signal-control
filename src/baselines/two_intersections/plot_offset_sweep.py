...
INPUT_CSV = "results/tables/offset_sweep_summary_0_90_2x2.csv"
...
def main():
    ...
    plot_metric(
        ...
        output_name="offset_0_90_vs_waiting_time.png",
    )
    ...
    plot_metric(
        ...
        y_label="Mean speed",
        output_name="offset_0_90_vs_mean_speed.png",
    )
    ...
    plot_metric(
        ...
        output_name="offset_0_90_vs_queue.png",
    )
