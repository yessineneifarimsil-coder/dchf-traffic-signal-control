...
INPUT_CSV = "results/raw/qmix_corridor_v2_turning_per_second.csv"
OUTPUT_CSV = "results/tables/qmix_v2_turning_summary.csv"
...
def main():
    ...
    summary = {
        "controller": "QMIX V2 transferred to Scenario B",
        "rows": len(df),
